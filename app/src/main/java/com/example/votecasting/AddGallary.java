...
public class AddGallary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_gallary);
        ...
        viewGallery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AddGallary.this, gallaryActivity.class);
        ...
        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(AddGallary.this, "Upload in progress", Toast.LENGTH_LONG).show();
                } else {
                    uploadImage();
                }
            }
    ...
    private void uploadImage() {
        if (imgUrl != null) {
            ...
            mUploadTask = fileReference.putFile(imgUrl)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    Uploads upload = new Uploads(imgDescription.getText().toString().trim(), uri.toString());
                                    String uploadID = mDatabaseRef.push().getKey();
                                    mDatabaseRef.child(uploadID).setValue(upload);
                                    Toast.makeText(AddGallary.this, "Upload successfully", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AddGallary.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(AddGallary.this, "No file selected", Toast.LENGTH_SHORT).show();
        }
    }
}
