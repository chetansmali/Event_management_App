...
public class AddEventDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStorageRef = FirebaseStorage.getInstance().getReference("Event");
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("Event");

        viewGallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AddEventDetails.this, eventActivity.class);
        ...
        btnUploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(AddEventDetails.this, "Upload in progress", Toast.LENGTH_LONG).show();
                } else {
                    uploadImage();
                }
            }
    ...
    private void uploadImage() {
        if (imgUrl != null) {
            ...
            mUploadTask = fileReference.putFile(imgUrl)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(AddEventDetails.this, "Upload successfully", Toast.LENGTH_LONG).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(AddEventDetails.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(AddEventDetails.this, "No file selected", Toast.LENGTH_SHORT).show();
        }
    }
}
