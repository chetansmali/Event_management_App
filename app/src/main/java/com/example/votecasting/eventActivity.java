...
public class eventActivity extends AppCompatActivity implements ImageAdapter.OnItemClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       b1 = (Button)findViewById(R.id.button2);
        ...
        mAdapter = new ImageAdapter(eventActivity.this, mUploads);
       ...
       b1.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View view) {
               Intent x = new Intent( eventActivity  .this,FacultyHomeActivity.class);
               startActivity(x);
           }
       });
